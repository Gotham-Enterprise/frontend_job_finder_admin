...
export default function CreateEmployersNewsletterPage() {
  return (
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Create Employers Newsletter</h1>
        <Link href="/admin/news-letter/employers" className="text-primary underline">
          Back
        </Link>
      </div>
