...
import DashboardRefreshButton from "@/components/header/DashboardRefreshButton";
...
const AppHeader: React.FC = () => {
  ...
  useEffect(() => {
    const initKeyDown = (event: KeyboardEvent) => {
    ...
    return () => {
      document.removeEventListener("keydown", initKeyDown);
    };
  }, []);
