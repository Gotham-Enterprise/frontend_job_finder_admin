...
export default function PricingTable() {
  ...
  const getOrderedPlans = (plans: PricingPlan[]) => {
    const planOrder = ["SMALL BUSINESS", "PROFESSIONAL PLAN", "MEDIUM BUSINESS PLAN", "ENTERPRISE PLAN"];

    return [...plans].sort((a, b) => {
      const aIndex = planOrder.findIndex(
        (order) =>
          a.name.toUpperCase().includes(order.toUpperCase()) || order.toUpperCase().includes(a.name.toUpperCase())
      );
      const bIndex = planOrder.findIndex(
        (order) =>
          b.name.toUpperCase().includes(order.toUpperCase()) || order.toUpperCase().includes(b.name.toUpperCase())
      );
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">Choose your subscription plan</h1>
            ...
            <div className="grid grid-cols-4 gap-1">
              {PLAN_INTERVALS.map((interval) => (
                ...
                >
                  ...
                  {interval.discount && (
                    <div
                      className={`text-xs ${selectedInterval === interval.value ? "text-blue-100" : "text-green-600"}`}
                    >
                      {interval.discount}
                    </div>
                  )}
              ...
              <div className="p-6">
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="mb-4">
                    ...
                    <span className="text-gray-500 dark:text-gray-400 text-sm">/{selectedInterval.toLowerCase()}</span>
                  </div>
                ...
                <div className="border-t border-gray-200 dark:border-gray-600 pt-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium text-gray-900 dark:text-white">{plan.planInclusions.jobPost}</span>
                    </div>
