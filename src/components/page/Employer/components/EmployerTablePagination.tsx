...
import { EmployerTablePaginationProps } from '@/services/types/EmployerTypes';

const EmployerTablePagination: React.FC<EmployerTablePaginationProps> = ({
  data,
  filters,
  onPageChange,
}) => {
...
export default EmployerTablePagination;
