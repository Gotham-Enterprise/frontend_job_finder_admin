...
import { JobApplicationsTablePaginationProps } from '@/services/types/JobApplicationsTypes';

const JobApplicationsTablePagination: React.FC<JobApplicationsTablePaginationProps> = ({
  data,
  filters,
  onPageChange,
  itemsPerPageOptions,
...
export default JobApplicationsTablePagination;
