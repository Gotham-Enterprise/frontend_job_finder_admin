...
const TagList: React.FC<TagListProps> = ({
  ...
  return (
    <>
      <FullScreenSpinner isVisible={isDeleting || isBulkDeleting} message="Deleting tag..." />
            ...
            <TableBody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              {tags.map((tag) => (
                <TableRow key={tag.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  ...
                  <TableCell className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-500 dark:text-gray-400">{formatDate(tag.createdAt)}</div>
                  </TableCell>
            ...
            <div className="flex items-center justify-between">
              ...
              {metaData.totalPages > 1 ? (
                ...
                <div className="text-sm text-gray-500 dark:text-gray-400">
                  ...
                  {Math.min(metaData.page * metaData.limit, metaData.totalCount)} results
                </div>
              )}
            </div>
          </div>
