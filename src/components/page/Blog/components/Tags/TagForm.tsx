...
const TagForm: React.FC<TagFormProps> = ({
  ...
  const isDuplicate = existingTags.some((tag) => tag.name.toLowerCase().trim() === newTag.name.toLowerCase().trim());
      ...
      <div className="space-y-4">
        ...
        <div>
          <PermissionWrapper module="blog" action="add">
            <Button variant="default" onClick={onAddTag} className="w-full" disabled={isDisabled}>
