...
interface ArchiveBulkActionDropdownProps {
...
const ArchiveBulkActionDropdown: React.FC<ArchiveBulkActionDropdownProps> = ({
  selectedItems,
  itemType,
  onBulkRestore,
  onClearSelection,
  ...
  const buttonDisabled = !hasSelectedItems || isRestoring;
  ...
  return (
    <div className={`relative inline-block text-left ${className}`} ref={dropdownRef}>
      ...
      >
        {isRestoring ? 'Processing...' : 'Bulk Actions'}
      </Button>
          ...
          <div className="py-2">
            ...
            >
              <div className="flex-1">
                <div className="font-medium text-gray-900 dark:text-white">Restore</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">
                  Restore selected {itemType} from archive
                </div>
              </div>
            </button>
...
export default ArchiveBulkActionDropdown;
