...
const FloatingElementsPanel: React.FC<FloatingElementsPanelProps> = ({ 
  ...
  return (
    <div
      className={`fixed bg-white border border-gray-300 rounded-xl shadow-2xl z-50 transition-all duration-200 ${
        ...
        <div className="flex gap-2 overflow-x-auto">
          {elements.map((element) => (
            <button
              ...
              className="group flex flex-col items-center p-2 text-center hover:bg-gray-50 rounded-lg transition-all duration-200 border border-transparent hover:border-gray-200 hover:shadow-sm flex-shrink-0 min-w-[60px]"
              title={element.description}
            >
              <div className={`w-8 h-8 ${element.color} rounded-lg flex items-center justify-center mb-1 group-hover:scale-110 transition-transform duration-200 shadow-sm`}>
                {typeof element.icon === 'string' ? (
                  <span className="text-white font-bold text-xs">{element.icon}</span>
                ) : (
                  <div className="text-white scale-75">{element.icon}</div>
                )}
              </div>
          ...
          >
            <div className="w-8 h-8 bg-gray-500 rounded-lg flex items-center justify-center mb-1 group-hover:scale-110 transition-transform duration-200 shadow-sm">
