...
import { SupervisorTablePaginationProps } from "@/services/types/SupervisorTypes";

const SupervisorTablePagination: React.FC<SupervisorTablePaginationProps> = ({
  data,
  filters,
  onPageChange,
  itemsPerPageOptions,
...
export default SupervisorTablePagination;
