...
interface Props {
  showModal: UseDocumentVerificationLogic["showModal"];
  modalData: UseDocumentVerificationLogic["modalData"];
  onToggleModal: UseDocumentVerificationLogic["onToggleModal"];
}

const DocumentVerificationModal: FC<Props> = ({ showModal, modalData, onToggleModal }) => {
