...
interface Props {
  ...
  metaData: UseDocumentVerificationLogic["metaData"];
  filters: UseDocumentVerificationLogic["filters"];
  itemsPerPageOptions: UseDocumentVerificationLogic["itemsPerPageOptions"];
  onFilterChange: UseDocumentVerificationLogic["onFilterChange"];
}

const DocumentVerificationTablePagination: FC<Props> = ({
  data,
  isLoading,
  metaData,
  filters,
    ...
    <div className="px-6 py-4 border-t border-gray-200 dark:border-gray-800">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="text-sm text-gray-500 dark:text-gray-400">
          ...
          {Math.min(metaData.page * (filters.limit || 50), metaData.totalCount)} of {metaData.totalCount} results
        </div>
...
export default DocumentVerificationTablePagination;
