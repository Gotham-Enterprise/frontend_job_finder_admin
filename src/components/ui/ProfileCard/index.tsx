                    ...
                    <div className="w-full mb-6">
                        ...
                        <div className={getContainerClasses(showAllResumes, profileData.documents.filter(doc => 
                            ...
                            {getResumesToShow().map((document, index) => (
                                ...
                                >
                                    <div className="w-10 h-10 rounded-lg flex items-center justify-center mr-3 bg-gradient-to-br from-blue-500 to-blue-600 group-hover:from-blue-600 group-hover:to-blue-700 transition-all duration-200 shadow-sm">
                        ...
                        <div className={getContainerClasses(showAllDocuments, profileData.documents.filter(doc => 
                            ...
                            {getDocumentsToShow().map((document, index) => (
                                <div 
                                    ...
                                    onClick={() => window.open(document.url, '_blank')}
                                >
                                    <div className="w-10 h-10 rounded-lg flex items-center justify-center mr-3 bg-gradient-to-br from-purple-500 to-purple-600 group-hover:from-purple-600 group-hover:to-purple-700 transition-all duration-200 shadow-sm">
                                        <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
